/*
 * Implementation of Enhanced Conflict-based Search (ECBSG)
 *
 * - ref
...
protected:
    ...
    std::vector<std::set<size_t>> agents_division;

public:
    ECBSG(Problem *_P);
    ECBSG(Graph *g, Config starts, Config goals);
    ~ECBSG(){};
