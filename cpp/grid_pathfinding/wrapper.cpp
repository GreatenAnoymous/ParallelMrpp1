...
PYBIND11_MODULE(Grids, m)
{
    ...
    pybind11::class_<Graph>(m, "Graph")
        ...
        .def("countEdges", &Graph::countEdges)
    ...
    pybind11::class_<Grid, Graph>(m, "Grid")
        ...
        .def("getLargestConnectedComponent", &Grid::getLargestConnectedComponent, "get comp", py::return_value_policy::reference)
    ...
    pybind11::class_<Grid8Connected, Grid>(m, "Grid8Connected")
        .def(pybind11::init<int, int, std::vector<std::vector<int>>>())
        .def(pybind11::init<const std::string &>());
}